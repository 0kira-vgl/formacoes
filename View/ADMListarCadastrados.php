    ...
    <div class="w3-container">
      <table class="w3-table-all w3-centered">
        ...
        <form action="/Controller/Navegacao.php" method="post" style="margin:0;">
            ...
            <button name="btnVisualizarCadastro" class="w3-button w3-blue w3-round-large"><i class="fa fa-eye"></i></button>
        </form>
    </td>';
            echo '</tr>';
          }
      ...
      <div class="w3-row w3-section">
        <div>
          <button name="btnVoltar"
            class="w3-button w3-block w3-margin w3-blue w3-cell w3-round-large" style="width: 90%;"> Voltar
          </button>
        </div>
      </div>
    </form>
